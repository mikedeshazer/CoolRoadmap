...
<<<<<<< HEAD
            ...
            //if parameter for milestone is difficult instead of "difficulty"
            if(typeof milestoneObjs[i]['difficulty'] == "number"){
                    difficulty = difficulty + milestoneObjs[i]['difficulty'];
            }
            else{

                if(isNaN(milestoneObjs[i]['difficult'])){
                    difficulty = difficulty +10;
                 //console.log(difficulty)
                }
                else{
                     difficulty = difficulty + milestoneObjs[i]['difficult'];
                }
...
<<<<<<< HEAD
            ...
            if(typeof milestoneObjs[i]['difficulty'] == "number"){
                ...
                var thisWeight = milestoneObjs[j]['difficult'] / difficulty;
            }
            if(isNaN(thisWeight)){
                thisWeight = .1;
            }
...
>>>>>>> dev1
            ...
            if(format == "2 decimals"){
                if(loopCount >= milestoneObjs.length - 1){
                    ...
                    responseSkeleton.push(startingPoint.toString() + "" + lastGeneratedMilestoneNum.toFixed(2).toString().replace( /\d\./g, ".") + ".0"); 
                }
            } else {
                if (loopCount >= milestoneObjs.length-1) {
                    var endingPoint = parseInt(startingPoint) + 1;
                    ...
                    responseSkeleton.push(startingPoint + "." + lastGeneratedMilestoneNum.toFixed(2).toString().replace(/\d\./g, ".")); 
                }
            }
